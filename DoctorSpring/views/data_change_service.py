    ...
    for diagnose in diagnoses:
        ...
        if hasattr(diagnose,"pathology") and diagnose.pathology:
            ...
            if pathology.diagnoseMethod==constant.DiagnoseMethod.Mri:
                diagDict['payAmount']=diagnose.getPayCount(constant.DiagnoseMethodCost.Mri,postionLen,diagnose.getUserDiscount(diagnose.patientId))
                diagDict['diagnoseMethod']=constant.DiagnoseMethod.Mri
            elif pathology.diagnoseMethod==constant.DiagnoseMethod.Ct:
                diagDict['payAmount']=diagnose.getPayCount(constant.DiagnoseMethodCost.Ct,postionLen,diagnose.getUserDiscount(diagnose.patientId))
